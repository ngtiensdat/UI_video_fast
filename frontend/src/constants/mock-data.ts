...
export const MOCK_FOLLOWED_ACCOUNTS = [
  { name: "@tho_beo_bunny", handle: "@tho_beo_bunny", desc: "Đang hoạt động", status: "online", avatar: DEFAULT_AVATAR },
  { name: "@truyen_thuyet_sintel", handle: "@truyen_thuyet_sintel", desc: "🔴 Đang Live: Blender 4.3 CGI", status: "live", avatar: DEFAULT_AVATAR },
  { name: "@cam_xuc_thu_sau", handle: "@cam_xuc_thu_sau", desc: "Hoạt động 3 giờ trước", status: "offline", avatar: DEFAULT_AVATAR },
  { name: "@canh_hoang_hon", handle: "@canh_hoang_hon", desc: "Đang hoạt động", status: "online", avatar: DEFAULT_AVATAR },
  { name: "@goc_rong_dien_anh", handle: "@goc_rong_dien_anh", desc: "Đang hoạt động", status: "online", avatar: DEFAULT_AVATAR },
];
...
export const MOCK_FRIENDS_LIST: FriendItem[] = [
  { name: "@alex_tuong_lai", msg: "Visual đẹp quá bạn ơi! ⚡️", time: "10:45 AM", online: true, avatar: DEFAULT_AVATAR },
  { name: "@chloe_nhay_mua", msg: "Đã gửi một video", time: "Hôm qua", online: true, avatar: DEFAULT_AVATAR },
  { name: "@synth_lap_trinh", msg: "Bạn có rảnh làm cái beat mới không?", time: "2 ngày trước", online: false, avatar: DEFAULT_AVATAR },
];
